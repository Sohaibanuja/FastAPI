...
#import from documentation of fastapi
...
# while True:
#     try:
#         conn = psycopg2.connect(host = 'localhost', database= 'fastapi database', user= 'postgres', password='la3des123', cursor_factory=RealDictCursor)
#         cursor = conn.cursor()
